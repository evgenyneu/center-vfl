...
It aligns X and Y ceteres of the label and its superview. The `(<=1)` inequality constraints are needed to allow centering constraints do their job. If we had just `[superview][label]` it would stick the edges of the label and its superview together.
